...
public class EnemyScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (weaponHolder.GetComponentInChildren<WeaponScript>() != null)
            weaponHolder.GetComponentInChildren<WeaponSHScript>().active = false;
    ...
    public void Ragdoll()
    {
        ...
        if (weaponHolder.GetComponentInChildren<WeaponSHScript>() != null)
        {
            WeaponSHScript w = weaponHolder.GetComponentInChildren<WeaponSHScript>();
            w.Release();
    ...
    public void Shoot()
    {
        ...
        if (weaponHolder.GetComponentInChildren<WeaponScript>() != null)
            weaponHolder.GetComponentInChildren<WeaponSHScript>().Shoot(GetComponentInChildren<ParticleSystem>().transform.position, transform.rotation, true);
    }
